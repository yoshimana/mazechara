(() => {
  ...
  const text = {
    ...
    '濃さ': 'Opacity', 'ぼかし': 'Blur', 'ライトの幅': 'Light width', '角度': 'Angle', '背景ボケ': 'Background blur', '背景ボケ (被写界深度)': 'Background blur (depth of field)',
    ...
    '画像全体表示': 'Show entire image',
    'キャラクターを中心に幅いっぱいで表示': 'Fit character in center',
    'キャラクターを中心に表示': 'Center character',
    ...
    '6. 実験的機能: 手前の物体で隠す': '6. Experimental: Bring Foreground Forward',
    '実験的機能: 手前の物を前面に出す': 'Experimental: Bring Foreground Forward',
    '手前の物を前面に出す': 'Bring Foreground Forward',
    '手前の物体で隠す': 'Bring Foreground Forward',
    '手前の物をなぞって設定': 'Trace Foreground Objects',
    '遮蔽マスクを作成・編集': 'Trace Foreground Objects',
    '遮蔽マスクを編集': 'Edit Foreground Objects',
    'マスクを消去': 'Clear mask',
    '未作成': 'Not set',
    '作成済み': 'Set',
    '手前の物をなぞって前面に出す': 'Trace Objects to Bring Forward',
    '手前の物体をなぞって遮蔽': 'Trace Objects to Bring Forward',
    '実験的機能': 'Experimental',
    'なぞる': 'Brush',
    'ブラシ（手前の物をなぞる）': 'Brush (trace objects)',
    'ブラシ（なぞって遮蔽）': 'Brush (trace objects)',
    '移動': 'Pan',
    '手のひら（キャンバス移動・グラブ）': 'Hand (pan & grab canvas)',
    'ズームリセット（全体表示）': 'Reset zoom (fit view)',
    '表示ズーム': 'Zoom',
    '遮蔽表示ズーム': 'Zoom',
    '画像全体表示（ズームリセット）': 'Reset zoom (fit view)',
    '消しゴム': 'Eraser',
    '消しゴム（はみ出た部分を消去）': 'Eraser (remove unwanted parts)',
    '太さ': 'Size',
    '太さプレビュー': 'Size preview',
    '調整': 'Adjust',
    '境界感度・ぼかし調整': 'Adjust sensitivity & bleed',
    '境界感度・滲み調整': 'Adjust sensitivity & bleed',
    '境界感度': 'Edge sensitivity',
    '境界の滲み': 'Edge bleed',
    '境界のぼかし': 'Edge bleed',
    'すべて消去': 'Clear all',
    'クリア': 'Clear',
    'キャラを透かして表示': 'Show ghost character',
    '影を表示': 'Show shadows',
    '適用': 'Apply',
    '遮蔽を適用': 'Apply',
    '※手前の物を大まかになぞると輪郭に自動吸着します。キャラとの重なりを見ながら調整できます。': 'Roughly trace foreground objects to auto-snap to edges. Adjust while checking the character overlap.',
    '※物体の上を大雑把になぞると輪郭に自動吸着します。キャラの重なりを見ながら調整できます。': 'Roughly trace foreground objects to auto-snap to edges. Adjust while checking the character overlap.',
    '【実験的機能】写真の手前にある物（木・柱・机など）をなぞることで、キャラクターやその影が物の後ろに回り込んだような自然な奥行きを作ります。境界線のコントラストや色味によって自動判定の精度が異なります。': '[Experimental] Trace foreground objects (trees, pillars, desks, etc.) to naturally place the character and shadows behind them for realistic depth. Auto-detection accuracy may vary depending on contrast and colors.',
    '【実験的機能】写真の手前にある木・電柱・看板などをなぞることで、キャラクターやその影が物体の背後に回り込んだような奥行きを作ります。境界線のコントラストや色味によって自動判定の精度が異なります。': '[Experimental] Trace foreground objects (trees, pillars, desks, etc.) to naturally place the character and shadows behind them for realistic depth. Auto-detection accuracy may vary depending on contrast and colors.',
    'キャラへの影': 'Shadow on character',
    '画像を読み込み中...': 'Loading image...',
    '背景写真を読み込み中...': 'Loading background photo...',
    'キャラクター画像を読み込み中...': 'Loading character image...',
    'トリミングを適用中...': 'Applying cropped image...',
    '背景写真を適用中...': 'Applying background photo...',
    'キャラクターを適用中...': 'Applying character image...'
  };
